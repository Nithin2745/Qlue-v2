...
const MODULE_WEIGHTS = {
  ...
  INTRO: { clarity: 0.30, structure: 0.25, confidence: 0.25, relevance: 0.20 },
  SELF_INTRO: { clarity: 0.30, structure: 0.25, confidence: 0.25, relevance: 0.20 } // Alias for backward compatibility
};
