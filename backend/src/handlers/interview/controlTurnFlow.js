...
const VALID_TRANSITIONS = {
    ...
    [INTERVIEW_STATES.AI_SPEAKING]: [INTERVIEW_STATES.USER_RESPONDING, INTERVIEW_STATES.GENERATING_FEEDBACK, INTERVIEW_STATES.ERROR],
    ...
    [INTERVIEW_STATES.SILENCE_DETECTED]: [INTERVIEW_STATES.AI_SPEAKING, INTERVIEW_STATES.GENERATING_FEEDBACK, INTERVIEW_STATES.ERROR],
