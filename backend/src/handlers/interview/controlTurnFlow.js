...
const VALID_TRANSITIONS = {
    [INTERVIEW_STATES.INITIALIZING]: [INTERVIEW_STATES.LOADING_CONTEXT, INTERVIEW_STATES.AI_SPEAKING, INTERVIEW_STATES.GENERATING_FEEDBACK, INTERVIEW_STATES.TERMINATED, INTERVIEW_STATES.ERROR],
    [INTERVIEW_STATES.LOADING_CONTEXT]: [INTERVIEW_STATES.AI_SPEAKING, INTERVIEW_STATES.GENERATING_FEEDBACK, INTERVIEW_STATES.TERMINATED, INTERVIEW_STATES.ERROR],
    ...
    [INTERVIEW_STATES.USER_RESPONDING]: [INTERVIEW_STATES.PROCESSING_RESPONSE, INTERVIEW_STATES.SILENCE_DETECTED, INTERVIEW_STATES.GENERATING_FEEDBACK, INTERVIEW_STATES.TERMINATED, INTERVIEW_STATES.ERROR], 
    ...
    [INTERVIEW_STATES.PROCESSING_RESPONSE]: [INTERVIEW_STATES.AI_SPEAKING, INTERVIEW_STATES.GENERATING_FEEDBACK, INTERVIEW_STATES.TERMINATED, INTERVIEW_STATES.ERROR],
